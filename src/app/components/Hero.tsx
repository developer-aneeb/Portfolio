      ...
      <div className="text-center max-w-4xl">
        ...
        >
          <h1 className="text-6xl md:text-8xl font-bold mb-4 whitespace-nowrap">
            {"ANEEB UR REHMAN".split("").map((letter, index) => (
              <motion.span
                key={index}
        ...
        >
          I build AI-powered products that turn raw data into real-world systems.
        </motion.p>
        ...
        <motion.div
          ...
          className="space-y-4"
        >
          <div className="text-lg text-gray-400">AI / DL / OCR Systems Builder</div>
          <div className="text-blue-400">Specializing in OCR pipelines, AI integration, scalable web apps, and production-ready engineering.</div>
        </motion.div>
      </div>
    </section>
  );
